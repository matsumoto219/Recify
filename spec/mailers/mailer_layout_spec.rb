...
RSpec.describe 'Mailer layout', type: :mailer do
  ...
  def expect_soft_mailer_palette(html)
    aggregate_failures do
      ...
      expect(html).to include('class="mailer-brand" align="left" style="padding: 0 0 22px;"')
      expect(html).to include('class="mailer-brand-logo"')
      ...
      expect(html).to include('brand/recify-logo-wordmark')
      expect(html).to include('alt="Recify - Receipt Management"')
      expect(html).to include('width="220"')
      expect(html).to include('height="48"')
      expect(html).to include('margin: -6px 0 0 40px')
      expect(html).to include('margin-left: -14px')
