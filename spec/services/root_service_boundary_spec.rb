...
RSpec.describe "root service and lifecycle status boundary" do
  ROOT_CLASSIFICATIONS = {
    ...
    "receipt_search.rb" => { constant: "ReceiptSearch", role: :legacy_query, owner: "migrate to app/queries and Receipts read API", remove_in_loop: 6 },
  ...
  EXTERNAL_METHODS = {
    ...
    "receipt_analysis_pipeline.rb" => %i[ai_enabled_env_key finalize_decision_from_snapshot ocr_enabled_env_key run_ai run_finalize run_ocr],
    ...
    "receipt_search.rb" => %i[index_query validate_query],
    ...
    "system_operations.rb" => %i[execute_ip_access_operation execute_receipt_analysis_cleanup execute_receipt_moderation_operation execute_user_operation reset_setting update_setting update_user_limit user_limit_update_confirmation_text],
  ...
  DECLARED_SINGLETON_METHODS = {
    ...
    "analysis.rb" => %i[build_receipt_params detect_category enforce_ownership_consistency evaluate_receipt_signal money_token_matches normalize_compact_store_name_candidate normalize_receipt_items normalize_store_name_candidate ownership_review_reason_resolved? processing_error_category processing_error_mapping receipt_item_ai_allowed_keys resolve_receipt_fact_ownership retry_confirmation_text retry_eligibility retry_receipt_analysis retry_types source_evidence_index store_name_brand_candidate_from_legal_entity store_name_candidate_valid? store_name_customer_facing_heading_candidates store_name_descriptive_heading_line? store_name_isolated_logo_fragment? store_name_latin_logo_prefix_duplicate? store_name_legal_entity_name? store_name_message_line? store_name_operator_candidates store_name_operator_context_line? store_name_operator_legal_entity_candidate? tax_detail_line_evidence],
    ...
    "receipt_analysis_pipeline.rb" => %i[ai_enabled_env_key finalize finalize_decision_from_snapshot ocr_enabled_env_key run_ai run_finalize run_ocr],
