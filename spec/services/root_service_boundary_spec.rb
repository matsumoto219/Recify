...
RSpec.describe "root service and lifecycle status boundary" do
  ...
  EXTERNAL_METHODS = {
    ...
    "user_sessions.rb" => %i[cleanup_retention record_sign_in record_sign_out retention_cutoff revoke_all! summary_for touch_current],
  ...
  DECLARED_SINGLETON_METHODS = {
    ...
    "user_sessions.rb" => %i[active_for cleanup_retention mark_revoked_for_user record_sign_in record_sign_out retention_cutoff retention_days revoke_all! summary_for touch_current],
    "users.rb" => %i[account_deletion_email_digest delete_account]
  }.freeze
