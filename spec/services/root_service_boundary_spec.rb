...
RSpec.describe "root service and lifecycle status boundary" do
  ...
  EXTERNAL_METHODS = {
    ...
    "security.rb" => %i[ip_access_snapshot ip_address_blockable? ip_address_non_blockable_reason ip_blocked? manual_ip_block manual_ip_unblock normalize_ip_address rack_attack_ban_reset rack_attack_banned_states rack_attack_default_target record_ip_access_operation record_ip_rate_limit_action request_ip_snapshot],
  ...
  DECLARED_SINGLETON_METHODS = {
    ...
    "security.rb" => %i[ip_access_snapshot ip_address_blockable? ip_address_non_blockable_reason ip_blocked? manual_ip_block manual_ip_unblock normalize_ip_address rack_attack_ban_reset rack_attack_banned_states rack_attack_default_target record_ip_access_operation record_ip_action record_ip_rate_limit_action request_ip_snapshot],
    ...
    "user_sessions.rb" => %i[active_for cleanup_retention mark_revoked_for_user record_sign_in record_sign_in! record_sign_out retention_cutoff retention_days revoke_all! summary_for touch_current],
    "users.rb" => %i[account_deletion_email_digest delete_account]
  }.freeze
