class Receipts::Processing::Pipeline
  class FinalizeStep
    ...
    def save_ai_result!(ocr_result, ai_result)
      ...
      limit_validator.validate_amount_limits!(
        receipt_attributes: params[:receipt_attributes],
    ...
    def persist_result_full!(receipt_attributes:, items_attributes:, payments_attributes:, tax_details_attributes:, adjustments_attributes: [])
      limit_validator.validate_structural_limits!(
        {
          receipt_items_attributes: items_attributes,
          receipt_adjustments_attributes: adjustments_attributes,
          receipt_payments_attributes: payments_attributes,
          receipt_tax_details_attributes: tax_details_attributes
        }
      )
    ...
    def limit_validator
      @limit_validator ||= LimitValidator.new(receipt: receipt)
    end
