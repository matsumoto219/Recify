...
class ReceiptAmountService
  ...
  def normalize_item(i)
...

    {
      ...
      amount_line_total_present: explicit_input_presence(i, :amount_line_total_present, line_total),
      amount_countable_source_changed: fetch_value(i, :amount_countable_source_changed),
      amount_line_total_changed: fetch_value(i, :amount_line_total_changed),
      amount_persisted_item: fetch_value(i, :amount_persisted_item),
      amount_persisted_original_line_total: to_i_or_nil(fetch_value(i, :amount_persisted_original_line_total)),
      amount_persisted_discount_amount: to_i_or_nil(fetch_value(i, :amount_persisted_discount_amount)),
      amount_persisted_discount_rate: fetch_value(i, :amount_persisted_discount_rate),
      amount_persisted_line_total: to_i_or_nil(fetch_value(i, :amount_persisted_line_total)),
