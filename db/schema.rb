...
ActiveRecord::Schema[8.1].define(version: 2026_08_13_004416) do
  ...
  create_table "receipt_items", force: :cascade do |t|
    ...
    t.string "reference_price_tax_inclusion"
    ...
    t.check_constraint "reference_price_tax_inclusion IS NULL OR (reference_price_tax_inclusion::text = ANY (ARRAY['gross'::character varying, 'net'::character varying]::text[]))", name: "check_receipt_items_reference_price_tax_inclusion"
